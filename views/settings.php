...
<form method="post">
    <fieldset style="padding: 0.5em;">
        ...
        <table class="fieldset" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td class="label"><label for="mm_cache_dir"><?php echo __('Cache directory'); ?>: </label></td>
                <td class="field">
                    <input type="text" value="<?php echo $mm_cache_dir ?>" name="mm_cache_dir" id="mm_cache_dir" />
                </td>
            ...
            <tr>
                <td class="label"><label for="mm_cache_extension"><?php echo __('Cache files extension'); ?>: </label></td>
                <td class="field">
                    <input type="text" value="<?php echo $mm_cache_extension ?>" name="mm_cache_extension" id="mm_cache_extension" />
                </td>
                <td class="help"><?php echo __('Set the extension for cache files (eg. ".cache", ".php")'); ?></td>
            </tr>
            <tr>
                <td class="label"><label for="mm_cache_default_timeout"><?php echo __('Default timeout'); ?>: </label></td>
                <td class="field">
                    <input type="text" value="<?php echo $mm_cache_default_timeout ?>" name="mm_cache_default_timeout" id="mm_cache_default_timeout" />
                </td>
